...
| [`docs/OTA.md`](docs/OTA.md) | Cập nhật firmware từ xa cho trang kỹ thuật viên: đường đi của lệnh, những gì giao diện cố tình chặn, và điều kiện thiết bị còn thiếu |
