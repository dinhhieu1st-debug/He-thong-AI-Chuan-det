...
PROJECTNAME = bootloader-storage-internal-single-3200k
ARM_GCC_DIR_WIN = $(USER_DIR)/.silabs/slt/installs/conan/p/gcc-ab83b3403fdca6/p
ARM_GCC_DIR_OSX = 
ARM_GCC_DIR_LINUX = 
POST_BUILD_EXE_WIN = $(USER_DIR)/.silabs/slt/installs/archive/Simplicity Commander/commander.exe
POST_BUILD_EXE_OSX = 
...
####################################################################
-include bootloader-storage-internal-single-3200k.project.mak
