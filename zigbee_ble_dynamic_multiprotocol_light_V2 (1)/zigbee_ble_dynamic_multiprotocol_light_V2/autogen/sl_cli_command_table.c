...
static const sl_cli_command_info_t cli_cmd_gap_start_hyphen_scan = \
  SL_CLI_COMMAND(sl_zigbee_af_ble_gap_start_scan_command,
                 "Starts the GAP Scan procedure",
...
static const sl_cli_command_info_t cli_cmd_gap_scan_hyphen_config = \
  SL_CLI_COMMAND(sl_zigbee_af_ble_gap_scan_config_command,
                 "Configure the scanning timing",
                  "Mode (0=passive, 1=active)" SL_CLI_UNIT_SEPARATOR "Interval" SL_CLI_UNIT_SEPARATOR "Window" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_gap_stop_hyphen_scan = \
  SL_CLI_COMMAND(sl_zigbee_af_ble_gap_stop_scan_command,
                 "Stop the GAP Scan procedure",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_entry_t gap_group_table[] = {
  ...
  { "start-scan", &cli_cmd_gap_start_hyphen_scan, false },
  { "scan-config", &cli_cmd_gap_scan_hyphen_config, false },
  { "stop-scan", &cli_cmd_gap_stop_hyphen_scan, false },
