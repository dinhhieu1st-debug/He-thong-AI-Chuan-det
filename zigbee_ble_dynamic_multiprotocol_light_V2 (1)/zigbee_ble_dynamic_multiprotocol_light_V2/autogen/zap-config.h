...
#define ZCL_GENERATED_ATTRIBUTE_COUNT (87)
...
#define ZCL_GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x08  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
	  ...
	  { 0x0006, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x00  } }, /* 37 Cluster: Over the Air Bootloading, Attribute: OTA Upgrade Status, Side: client*/ \
		  ...
		  { 0x0011, ZCL_LONG_OCTET_STRING_ATTRIBUTE_TYPE, 255, (ATTRIBUTE_MASK_CLIENT), { NULL } }, /* 40 Cluster: Green Power, Attribute: proxy table, Side: client*/ \
...
#define ZCL_GENERATED_CLUSTERS { \
  { 0x0000, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[0]), 14, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0008, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[30]), 5, 7, CLUSTER_MASK_SERVER, NULL }, /* 5, Endpoint Id: 1, Cluster: Level Control, Side: server*/ \
	  { 0x0019, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[35]), 4, 15, CLUSTER_MASK_CLIENT, NULL }, /* 6, Endpoint Id: 1, Cluster: Over the Air Bootloading, Side: client*/ \
	  { 0x0406, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[85]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 7, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: client*/ \
	  { 0x1000, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[86]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 8, Endpoint Id: 1, Cluster: ZLL Commissioning, Side: server*/ \
	  ...
	  { 0x0008, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[30]), 5, 7, CLUSTER_MASK_SERVER, NULL }, /* 14, Endpoint Id: 2, Cluster: Level Control, Side: server*/ \
	  { 0x0019, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[35]), 4, 15, CLUSTER_MASK_CLIENT, NULL }, /* 15, Endpoint Id: 2, Cluster: Over the Air Bootloading, Side: client*/ \
	  { 0x0300, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[45]), 40, 66, CLUSTER_MASK_SERVER, NULL }, /* 16, Endpoint Id: 2, Cluster: Color Control, Side: server*/ \
	  { 0x1000, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[86]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 17, Endpoint Id: 2, Cluster: ZLL Commissioning, Side: server*/ \
	  { 0x0021, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[39]), 6, 280, CLUSTER_MASK_CLIENT, NULL } /* 18, Endpoint Id: 242, Cluster: Green Power, Side: client*/ \
	 }
...
#define ZCL_GENERATED_ENDPOINT_TYPES { \
  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[0])), 9, 50 }, \
	  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[9])), 9, 114 }, \
	  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[18])), 1, 280 }, \
	 } 
...
#define ZCL_ATTRIBUTE_MAX_SIZE (444)
